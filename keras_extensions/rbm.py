...
class RBM(Layer):
    ...
    def mcmc_chain(self, x, nb_gibbs_steps):
        ...
        result, _ = theano.scan(self.gibbs_xhx, outputs_info=(x, None, None), n_steps=nb_gibbs_steps)
        x_pres, x_sigms, x_samps = result
        x_rec = x_samps[-1] # sample of x at end of MCMC chain
        ...
        return x_rec, x_pres[-1], x_sigms[-1]
